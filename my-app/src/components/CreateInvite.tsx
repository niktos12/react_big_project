            ...
            <div className="bg-[#141416] flex flex-row w-[80%] justify-between items-center p-8 rounded-[30px] pl-12 lg:flex-col lg;justify-center lg:items-center m:p-4">
                <div className="flex flex-col lg:items-center m:justify-center m:text-center">
                    ...
                    <div className="flex flex-row gap-7">
                        <button className="py-4 px-6 bg-white rounded-xl text-[#141416] font-semibold xm:text-sm xm:py-2 xm:px-3">Explore More</button>
                        <button className="py-4 px-6 rounded-xl border-2 border-white text-white font-semibold  xm:text-sm xm:py-2 xm:px-3">Sell Artwork</button>
                    </div>
                </div>
