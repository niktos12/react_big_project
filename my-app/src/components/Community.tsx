...
export function Community(){
    return(
        <div className="flex flex-col justify-center items-center mb-56">
            <div 
                className="border-2 border-[#D2D2D2] rounded-[1061px] w-[1061px] h-[1061px] flex flex-col justify-center items-center relative"
            >
                <ImageComponent 
                ...
                />
                <div 
                    className="border-2 border-[#D2D2D2] rounded-[831px] w-[831px] h-[831px] flex flex-col gap-7 justify-center items-center relative"
                >
                    <ImageComponent 
                    ...
                    <div className="not-animate flex flex-col justify-center items-center gap-7">
                        <h1 className="text-[#18181B] text-4xl font-bold text-center">Join The 
                            <span className="text-[#C5C5C5]">
                                <br></br>Community
                            </span>
                        </h1>
                        <p className="opacity-70 text-[#12141D] text-center text-lg">
